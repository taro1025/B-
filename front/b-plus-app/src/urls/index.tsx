const DEFAULT_API_LOCALHOST: string = 'http://example-1506320326.ap-northeast-1.elb.amazonaws.com:3000/api/v1' //'http://127.0.0.1/api/v1'; //'http://127.0.0.1:3000/api/v1';
